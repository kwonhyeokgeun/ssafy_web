...
function allSlide(onoff) {
  if (onoff === "on") {
    document.querySelectorAll(".store_item_sub").forEach((el) => el.setAttribute("style", "display: block"))
    ...
    document.querySelectorAll(".store_item_sub").forEach((el) => el.setAttribute("style", "display: none"))
...
function slideDown(area) {
  if (area.getAttribute("style") === "display: none") {
    opencnt++
    if (opencnt == 4) {
      document.querySelector(".store_display_on").setAttribute("style", "display: none")
      document.querySelector(".store_display_off").setAttribute("style", "display: block")
...
function slideDown(areaid) {
  ...
  if (areaid.style.display == "none") {
    areaid.style.display = "block" //area.setAttribute("style","display: block")
    cnt++
